...
fpath = 'training_plot_add_thickness_SiO2_50_layer_target_thicker_2'
...
class InitializeParameters:
    def __init__(self):
        ...
        self.optical_thickness_ratio = 1
    ...
    def init_init_layers(self, ratio=1):
        self.ratio = ratio
...
def main():
    ...
    d, materials = current_initialize.init_init_layers(5.)
