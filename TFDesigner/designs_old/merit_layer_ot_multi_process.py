...
def plot_spectrum(wls, target_spec, d, materials, layer_number, merit, insert_count):
    ...
    axR.plot(wls, get_spectrum(wls, d, materials, theta0=60.)
    ...
    axT = plt.subplot(122)
    axT.plot(wls, get_spectrum(wls, d, materials, theta0=60.)
             [wls.shape[0]:], label='fit')
...
def gradient_descent(wls, target_spec, d, materials, insert_layer_num, h_tol=1e-10):
    """
...
def insert_1_layer(wls, target_spec, d, materials, insert_search_pts):
    ...
    print(get_insert_jacobi.get_insert_jacobi_faster(
        wls, d, materials, insert_search_pts, theta0=60.).T)
    print(insert_gradient)
